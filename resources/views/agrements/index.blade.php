		                ...
		                <tbody>
		                	@foreach($agrements as $agrement)
			                    <tr>
			                    	...
			                    	<td>
										<!-- acienne version mis en commentaire par Jacskson pour permetrre aux utilisateurs de modifier un agrement-->
			                    		@can('edit')
										...
										<!--Jackson modif: permettre aux utilisateurs de modifier un agrement-->
										@can('edit')
										<a title="Modifier cet agrément"href="{{ route("agrement.edit", ["id" => $agrement->id]) }}"><button type="button" class="btn btn-outline btn-warning"><i class="fa fa-edit"></i></button></a>
										@endcan
